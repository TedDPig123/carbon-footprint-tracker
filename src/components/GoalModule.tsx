...
export default function GoalModule() {
    ...
    return (
        <>
            <h1 className='mt-[-20px] items-left mb-[6px] text-[#CDE4B0] font-bold text-[20px] w-[100%] ml-[10px]'>Carbon Footprint Goal</h1>
            <div className='flex flex-row items-stretch bg-[linear-gradient(95deg,_#CDE4B0_-22.13%,_#077000_153.73%)] h-[100px] w-[100%] rounded-[15px] text-[#022100]'>
